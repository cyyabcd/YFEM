...
for i1=1:3
    for j1=1:3
        ...
        for i = 1:6
            ...
            FEMBase{i1,j1}.coefficient(20*(i-1)+1:20*i,:) = A.coefficient;          
        end
    end
    ...
    for i = 1:6
        ...
        divFEMBase{i1, 1}.coefficient(20*(i-1)+1:20*i,:) = A.coefficient;
    end
end
for i = 1:6
...
sigmaDivDivBase = divDivFEMBase.LinearTransform(M);
for i = 1:nDim
    for j = 1:nDim
        sigmaBase{i,j} = FEMBase{i,j}.LinearTransform(M);
    end
end
