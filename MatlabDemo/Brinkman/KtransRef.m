function [phi, Dphi, J] = KtransRef(node,elem,GaussPt)
...
phi = zeros(8,1);% according to the order in nodes
phi(1) = g1(2)*g2(2)*g3(2);
phi(2) = g1(1)*g2(2)*g3(2);
phi(3) = g1(2)*g2(1)*g3(2);
phi(4) = g1(1)*g2(1)*g3(2);
phi(5) = g1(2)*g2(2)*g3(1);
phi(6) = g1(1)*g2(2)*g3(1);
phi(7) = g1(2)*g2(1)*g3(1);
phi(8) = g1(1)*g2(1)*g3(1);


rDphi = zeros(8,3);
rDphi(1,:) = [ -g2(2)*g3(2), -g1(2)*g3(2), -g1(2)*g2(2)];
rDphi(2,:) = [  g2(2)*g3(2), -g1(1)*g3(2), -g1(1)*g2(2)];
rDphi(3,:) = [ -g2(1)*g3(2),  g1(2)*g3(2), -g1(2)*g2(1)];
rDphi(4,:) = [  g2(1)*g3(2),  g1(1)*g3(2), -g1(1)*g2(1)];
rDphi(5,:) = [ -g2(2)*g3(1), -g1(2)*g3(1),  g1(2)*g2(2)];
rDphi(6,:) = [  g2(2)*g3(1), -g1(1)*g3(1),  g1(1)*g2(2)];
rDphi(7,:) = [ -g2(1)*g3(1),  g1(2)*g3(1),  g1(2)*g2(1)];
rDphi(8,:) = [  g2(1)*g3(1),  g1(1)*g3(1),  g1(1)*g2(1)];
